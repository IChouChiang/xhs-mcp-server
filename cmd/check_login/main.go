...
func main() {
	...
	// 4. Navigate to verify login
	fmt.Println("Navigating to Xiaohongshu Creator Studio with saved auth state...")
	if _, err = page.Goto("https://creator.xiaohongshu.com/publish/publish"); err != nil {
		log.Fatalf("could not goto: %v", err)
	}

	fmt.Println("Page loaded. You should see the logged-in interface.")
